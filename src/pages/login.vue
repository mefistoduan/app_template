<template>
    <div id="pages">
            ...
            <div class="form">
                ...
                <mt-field placeholder="验证码" v-model="register.valid">
                    <mt-button type="primary"
                               ...
                               @click.native="get_phone_valid(register.usercode,register.img_valid,1)">{{ valid_btn }}</mt-button>
                </mt-field>
        ...
        <div class="login pwd_login bg bg03" v-if="page == 2">
            <div class="back">
                <div class="b_lt" @click="goPage(0)"><img src="../../static/images/login/arrow-left@2x.png" alt="">
                </div>
            ...
            <div class="form">
                ...
                <mt-field placeholder="密码" type="password"  v-model="pwd_login.pwd"></mt-field>
                <mt-field placeholder="图形验证" v-model="pwd_login.img_valid">
                    <img :src="valImgSrc" @click="changeValImg" height="23" width="55">
                </mt-field>
            </div>
            ...
            <div class="form">
                ...
                <mt-field placeholder="验证码" v-model="phone_login.valid">
                    <mt-button type="primary"
                               class="valid_btn"
                               :disabled ="button_state"
                               @click.native="get_phone_valid(phone_login.usercode,phone_login.img_valid,3)">{{ valid_btn }}</mt-button>
                </mt-field>
            </div>
            ...
            <div class="form">
                ...
                <mt-field placeholder="验证码" v-model="forget.valid">
                    <mt-button type="primary"
                               class="valid_btn"
                               :disabled ="button_state"
                               @click.native="get_phone_valid(forget.usercode,forget.img_valid,2)">{{ valid_btn }}</mt-button>
                </mt-field>
                <mt-field placeholder="新密码"  v-model="forget.pwd" type="password"></mt-field>
            </div>
            <mt-button type="primary" class="register_confirm" @click.navtive="forget_confirm">登录并重置密码</mt-button>
        </div>
        <div class="version">
            V {{version}}
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            pwd_login_confirm(){
                ...
                if(!that.pwd_login.img_valid){
                    Toast('图形验证码不能为空');
                    return false
                }
                if(that.pwd_login.img_valid.length != 4  ){
                    Toast('图形验证码');
                    return false
                }
                let param = {
